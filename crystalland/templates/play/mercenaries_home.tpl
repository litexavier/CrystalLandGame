...
<script type='text/javascript'> navhilight('mercenaries'); </script>
{% include "play/guild_status_bar.tpl" %}
<div class='mercenary-slide' id='mercenaries-slide'>
...
<script type='text/javascript'> sv=new Sidenav('mercenaries-slide'); sv.setDefault(0);</script>
